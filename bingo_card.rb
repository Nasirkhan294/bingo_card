...
| B | I | N | G | O |
+---+---+---+---+---+
| #{b_col[0]} | #{b_col[1]} | #{b_col[2]} | #{b_col[3]} | #{b_col[4]} |
+---+---+---+---+---+
| #{i_col[0]} | #{i_col[1]} | #{i_col[2]} | #{i_col[3]} | #{i_col[4]} |
+---+---+---+---+---+
| #{n_col[0]} | #{n_col[1]} | F | #{n_col[2]} | #{n_col[3]} |
+---+---+---+---+---+
| #{g_col[0]} | #{g_col[1]} | #{g_col[2]} | #{g_col[3]} | #{g_col[4]} |
+---+---+---+---+---+
| #{o_col[0]} | #{o_col[1]} | #{o_col[2]} | #{o_col[3]} | #{o_col[4]} |
+---+---+---+---+---+
BINGO
